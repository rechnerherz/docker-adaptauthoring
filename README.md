...
```
docker build . -t "adapt-authoring:0.11.5" -t "adapt-authoring:latest"
```
...
```
docker tag "adapt-authoring:0.11.5" "rechnerherz/adapt-authoring:0.11.5"
docker tag "adapt-authoring:latest" "rechnerherz/adapt-authoring:latest"
docker push "rechnerherz/adapt-authoring:0.11.5"
